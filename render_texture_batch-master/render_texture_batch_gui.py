...
def renderStart():
    ...
    batch = subprocess.Popen([blender.get(), "-b", "--python-expr", "import sys;sys.path.append('.');import render_texture_batch; render_texture_batch.renderTextureBatch(" + batchArgs + ")"],
...
createToolTip(browseBlender, 'Browse for Blender executable')
